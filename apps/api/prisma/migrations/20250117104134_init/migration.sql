...
CREATE TABLE `User` (
    ...
    `role` ENUM('BUSINESS', 'USER', 'VISITOR') NOT NULL DEFAULT 'USER',
...
-- AddForeignKey
ALTER TABLE `Billboard` ADD CONSTRAINT `Billboard_imageId_fkey` FOREIGN KEY (`imageId`) REFERENCES `Image`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
